...
/scripts
generate_crm.py → builds dummy CRM (Clay-style)
build_flourish_export.py
→ generates nodes.csv + links.csv
...
`generate_crm.py` creates a complete internal CRM dataset, including:
...
## Next Steps
python scripts/build_popups.py
